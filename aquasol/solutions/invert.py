...
def aw_to_conc(
    ...
    out : str, optional
        Any concentration unit manageable by `convert()`. Default is 'w'.
    solute : str, optional
        Solute of interest. Default is 'NaCl'.
    T : float, optional
        Temperature. Default is 25.
    unit : str, optional
        Temperature unit ('C' or 'K'). Default is 'C'.
    source : str, optional
        Source for water activity. If None, the default source is used.
    ...
    Notes
    -----
    Part of the structure of this function resembles that of
